...
function MakeNotifi(Configs)
  local Title = Configs.Title or "DukeeHub"
...
function MakeWindow(Configs)
  local title = Configs.Hub.Title or "DukeeHub"
  local Anim_Title = Configs.Hub.Animation or "by : @DukeeHub"
  ...
  local function CreateClose()
    ...
    local Mensage = Create("TextLabel", CloseMenu, {
      ...
      Text = "Are you sure you want to close DukeeHub (Main)?",
