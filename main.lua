loadstring(game:HttpGet(("https://raw.githubusercontent.com/hluuvn/Roblox/refs/heads/main/main.lua")))()
       ...
       MinimizeButton({
       Image = "rbxassetid://71796505051136",
       Size = {60, 60},
     ...
     local Tab0 = MakeTab({Name = "Private Server"})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-GravityHub/BloxFruit/refs/heads/main/Main.lua"))()
    ...
    AddButton(Tab1, {
     Name = "Đạt Thg (No Key)",
    Callback = function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaCrack/DatThg/main/DatThgVnV4"))()
  end
  })
    AddButton(Tab1, {
     Name = "Maru Hub KimP (No Key)",
    Callback = function()
	  getgenv().Team = "Marines"
loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaCrack/KimP/refs/heads/main/MaruHub"))()
    ...
    AddButton(Tab1, {
     Name = "BlueX Hub (No Key)",
    Callback = function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-BlueX/BlueX-Hub/refs/heads/main/Main.lua"))()
  end
  })
    AddButton(Tab1, {
     Name = "Quantum Onyx Hub (No Key)",
    Callback = function()
